...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by creating a [GitHub issue](https://github.com/open-resource-discovery/global-registry-bot/issues).
...
- Before implementing your change, create an issue that describes the problem you would like to solve or the code that should be enhanced, and note that you are willing to work on it.
...
If you have questions about one of the issues, please comment on it, and one of the maintainers will clarify.
...
- Due to legal reasons, contributors will be asked to accept a Developer Certificate of Origin (DCO) when they create the first pull request to this project. This happens in an automated fashion during the submission process.
...
- The information you provide must be comprehensive enough to reproduce that issue for the assignee.
